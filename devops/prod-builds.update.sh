/srv/dumps.sh
systemctl stop web.app.service comm.app.service tg.app.service api.app.service bus.app.service constructor.app.service hd.app.service identity.app.service kladr.app.service ldap.app.service sports-log-service.app.service
...
cp -r /srv/git/builds/SportsLogService /srv/services/SportsLogRuService

chown -R www-data:www-data /srv/services
chmod -R 777 /srv/services
systemctl start comm.app.service web.app.service bus.app.service tg.app.service api.app.service hd.app.service constructor.app.service identity.app.service kladr.app.service ldap.app.service sports-log-service.app.service