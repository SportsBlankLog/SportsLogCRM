...
dotnet publish -c Debug --output C:/Users/User/Documents/publish/SportsLogService C:/Users/User/source/repos/BlankCRM/micro-services/ConnectorSportsLogApiService/ConnectorSportsLogApiService.csproj
