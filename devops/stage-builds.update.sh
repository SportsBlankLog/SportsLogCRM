systemctl stop web.app.stage.service comm.app.stage.service tg.app.stage.service api.app.stage.service bus.app.stage.service constructor.app.stage.service identity.app.stage.service hd.app.stage.service ldap.app.stage.service kladr.app.stage.service sports-log-service.app.stage.service
...
cp -r /srv/git/builds/SportsLogService /srv/services.stage/SportsLogService
chown -R www-data:www-data /srv/services.stage
chmod -R 777 /srv/services.stage
systemctl start comm.app.stage.service web.app.stage.service bus.app.stage.service tg.app.stage.service api.app.stage.service hd.app.stage.service constructor.app.stage.service identity.app.stage.service ldap.app.stage.service kladr.app.stage.service sports-log-service.app.stage.service